...
async function getapi(url) {
  ...
  var component1 = document.getElementById("formId");
  var component2 = document.getElementById("tableId");
  component1.classList.add("hide");
  component2.classList.remove("hide");
  ...
  for (var i = 0; i < data.length; i++){
    ...
    var td1 = document.createElement('td');   td1.innerHTML = keys[i];    tr.appendChild(td1);
    var td2 = document.createElement('td');   td2.innerHTML = data[i];    tr.appendChild(td2);
...
//   const targetDiv = document.getElementById("table");
// const targetDiv1 = document.getElementById("track");
